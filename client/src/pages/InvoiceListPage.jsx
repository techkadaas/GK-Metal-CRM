        ...
        <div className="p-4 border-b border-slate-200 bg-white space-y-3">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-3">
            ...
            <form onSubmit={handleSearchSubmit} className="md:col-span-6 relative">
              ...
              <input
                type="text"
                placeholder="Search invoice number, buyer company, GSTIN, test report..."
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                className="w-full pl-9 pr-20 py-2 border border-slate-300 rounded-lg text-xs font-medium text-slate-800 focus:ring-2 focus:ring-sky-500"
              />
              <button
                type="submit"
                className="absolute right-1.5 top-1.5 px-3 py-1 bg-slate-800 hover:bg-slate-700 text-white rounded text-[11px] font-semibold"
              >
                Search
              </button>
            </form>
            ...
            <div className="md:col-span-3 flex items-center gap-2">
              ...
              <select
                ...
                className="w-full px-2.5 py-2 border border-slate-300 rounded-lg text-xs font-medium text-slate-800 focus:ring-2 focus:ring-sky-500 bg-white"
              >
                  ...
                  <tr key={inv._id} className="hover:bg-slate-50/80 transition">
                    ...
                    <td className="py-3 px-4 text-center whitespace-nowrap">
                      <div className="flex items-center justify-center gap-1">
                        ...
                        <button
                          onClick={() => handleDuplicate(inv._id, inv.invoiceNumber)}
